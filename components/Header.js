...
const items = [
    { icon: 'fab fa-youtube', link: 'https://youtube.com/AhmetYTK' },
...
const navItems = [
    ...
    { icon: 'fal fa-rss', active: 'fa fa-rss', label: 'Blogs', href: 'https://burmetv.tr.gg' }
]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">Merhaba ben AhmetYTK</p>
